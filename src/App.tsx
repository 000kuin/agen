  ...
  return (
    <>
      ...
      <nav className={`nav${scrolled?' scrolled':''}`}>
        ...
        <a href="https://robinhoodchain.blockscout.com/address/0x5d84b017017c7c977a6f70268e106e594f494df5" target="_blank" rel="noreferrer" className="nav-cta">Acquire $AGEN</a>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-btns">
            <a href="https://robinhoodchain.blockscout.com/address/0x5d84b017017c7c977a6f70268e106e594f494df5" target="_blank" rel="noreferrer" className="btn-primary">Acquire $AGEN</a>
            <a href="https://robinhoodchain.blockscout.com/address/0x5d84b017017c7c977a6f70268e106e594f494df5" target="_blank" rel="noreferrer" className="btn-ghost">Read contract ↗</a>
          </div>
        </div>
      ...
      <div className="content">
        ...
        <div className="finale">
          ...
          <div className="hero-btns">
            <a href="https://robinhoodchain.blockscout.com/address/0x5d84b017017c7c977a6f70268e106e594f494df5" target="_blank" rel="noreferrer" className="btn-primary">Acquire $AGEN</a>
            <a href="https://robinhoodchain.blockscout.com/address/0x5d84b017017c7c977a6f70268e106e594f494df5" target="_blank" rel="noreferrer" className="btn-ghost">View contract ↗</a>
          </div>
        </div>
        ...
        <footer className="footer">
          ...
          <ul className="footer-links">
            <li><a href="https://robinhoodchain.blockscout.com/address/0x5d84b017017c7c977a6f70268e106e594f494df5" target="_blank" rel="noreferrer">Contract ↗</a></li>
            <li><a href="#/docs" onClick={(e) => { e.preventDefault(); window.location.hash = '/docs' }}>Docs</a></li>
          </ul>
